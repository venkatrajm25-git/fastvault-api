...
from model.v1.user_model import Users  # Adjust import to your model
...
def test_user_id_generation_high_ids(db_session):
    ...
    test_user = Users(id=99999, email="dummyuser@123.com", username="DummyUser")
    ...
    db_session.query(Users).filter_by(id=99999).delete()
    db_session.commit()
